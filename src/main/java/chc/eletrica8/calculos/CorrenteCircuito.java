...
public class CorrenteCircuito {
    ...
    public CorrenteCircuito(String tipoCorrente) {
        this.tipoCorrente = tipoCorrente;
    }

    public CorrenteCircuito withCarga(List<Carga> carga) {
        this.carga = carga;
        return this;
    }

    public CorrenteCircuito withLigacao(Ligacao ligacao) {
        this.FASES_CIRCUITO = ligacao.getNumeroFases();
        return this;
    }
        ...
        switch (FASES_CIRCUITO) {
            ...
            case 1:
                for (int h = 0; h < FN.size(); h++) {
                    ...
                    carga.get(AUX).getResultados().setLigacaoReal("AN");
                    AUX += 1;
                }
                break;
                ...
                for (int i = 0; i < cargaSeq.size(); i++) {
                    if (cargaSeq.get(i) == 1) {
                        if (SOMA_AN <= SOMA_BN) {
                            ...
                            carga.get(AUX).getResultados().setLigacaoReal("BN");;
                            //CargaService.salva(carga.get(AUX));
                            AUX += 1;
                        }
                        aux3 += 1;
                        ...
                        carga.get(AUX).getResultados().setLigacaoReal("AB");
                        //CargaService.salva(carga.get(AUX));
                        AUX += 1;
                        aux4 += 1;
                    }
                ...
                for (int i = 0; i < cargaSeq.size(); i++) {
                    if (cargaSeq.get(i) == 1) {
                        if (SOMA_AN <= SOMA_BN && SOMA_AN <= SOMA_CN) {
                            ...
                            carga.get(AUX).getResultados().setLigacaoReal("CN");
                            AUX += 1;
                        }
                        aux5 += 1;
                        ...
                        if (SOMA_AB <= SOMA_BC && SOMA_AB <= SOMA_CA) {
                            ...
                            carga.get(AUX).getResultados().setLigacaoReal("BC");
                            AUX += 1;
                        } else if (SOMA_CA <= SOMA_AB && SOMA_CA <= SOMA_BC) {
                            SOMA_CA = SOMA_CA + FF.get(aux6);
                            carga.get(AUX).getResultados().setLigacaoReal("CA");
                            AUX += 1;
                        }
                        aux6 += 1;
                    } else if (cargaSeq.get(i) == 3) {
                        SOMA_ABC = SOMA_ABC + FFF.get(aux7);
                        carga.get(AUX).getResultados().setLigacaoReal("ABC");
                        AUX += 1;
                        aux7 += 1;
                    }
                }
